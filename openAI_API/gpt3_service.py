...
def gpt3_completion(_prompt, engine='text-davinci-003', temp=0.6, top_p=1.0, tokens=2000, freq_pen=0.25, pres_pen=0.0,
                    stop=['<<END>>']):
    max_retry = 5
    retry = 0
    while True:
        try:
            ...
            print('Erro de comunicação com a API da OpenAI:', oops)
            sleep(1)
